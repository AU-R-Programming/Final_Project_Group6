...
The next step is to run the model by calling the `our_lm` function. We compare our results to those of the built-in `lm` function. We can see that the results are very similar.
